...
$(document).ready(function () {
    function initTextPopovers() {
        $('*[data-toggle="popover"]').each(function () {
            let mode = $(this).attr("data-pop-mode");
            let title = $(this).attr("data-pop-title");
            let content = $(this).attr("data-pop-content");
            let position = $(this).attr("data-pop-position");
            let width = $(this).attr("data-pop-width");
            let avatar = $(this).attr("data-pop-avatar");
            let icon = $(this).attr("data-pop-icon");
            let iconColor = $(this).attr("data-pop-iconbg");
            let avatarHtml = "";
            let iconHtml = "";
    ...
    function initUserPopovers() {
        $("*[data-user-popover]").each(function () {
            let e = $(this);
            let userRef = $(this).attr("data-user-popover");

            let mailIcon = feather.icons.mail.toSvg();
            let phoneIcon = feather.icons.phone.toSvg();
            let profileIcon = feather.icons["more-horizontal"].toSvg();
            ...
            $.ajax({
                ...
                success: function (data) {
                    e.webuiPopover({
                        ...
                        cache: false,
                        content: function () {
                            let destroyLoader = setTimeout(function () {
                                    ...
                                    <div class="profile-popover-block">
                                        ...
                                        <div class="profile-popover-wrapper">
                                            <div class="popover-avatar">
                                                <img class="avatar" src="${data[userRef].pic}" alt="Avatar">
                                                <img class="badge" src="${data[userRef].badge}" alt="Badge user">
                                            </div>
                                    ...
                                    <div class="profile-popover-block">
                                        ...
                                        <div class="profile-popover-wrapper">
                                            <div class="popover-fake-avatar ${randomClass}">
                                                ...
                                                <img class="badge" src="${data[userRef].badge}" alt="Badge">
                                            </div>
                                            <div class="popover-meta">
                                                <span class="user-meta">
                                                    <span class="username">${data[userRef].name}</span>
